...
function InstallmentsTable() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InstallmentsTable.useEffect": ()=>{
            const fetchInstallments = {
                "InstallmentsTable.useEffect.fetchInstallments": async ()=>{
                    let q;
                    if (clientFilter) {
                    ...
                    const installmentsData = querySnapshot.docs.map({
                        "InstallmentsTable.useEffect.fetchInstallments.installmentsData": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["InstallmentsTable.useEffect.fetchInstallments.installmentsData"]);
                    setInstallments(installmentsData);
                }
            }["InstallmentsTable.useEffect.fetchInstallments"];
            fetchInstallments();
        }
    }["InstallmentsTable.useEffect"], [
        clientFilter
    ...
    const editInstallment = async (updatedInstallment)=>{
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(installmentRef, {
                ...updatedInstallment
            });
            setInstallments(installments.map((installment)=>installment.id === updatedInstallment.id ? updatedInstallment : installment));
            toast({
...
//# sourceMappingURL=src_b780c951._.js.map