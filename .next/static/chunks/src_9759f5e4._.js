...
function UsersPage() {
        ...
        "UsersPage.useCallback[fetchUsers]": async ()=>{
            try {
                ...
                const usersData = querySnapshot.docs.map({
                    "UsersPage.useCallback[fetchUsers].usersData": (doc)=>({
                            id: doc.id,
                            ...doc.data()
                        })
                }["UsersPage.useCallback[fetchUsers].usersData"]);
                setUsers(usersData);
            } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UsersPage.useEffect": ()=>{
            const seedOwner = {
                "UsersPage.useEffect.seedOwner": async ()=>{
                    ...
                    if (querySnapshot.empty) {
                        try {
                            ...
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])(usersRef, newUserData);
                            toast({
...
_s(UsersPage, "EN56gJ/kBsjSB0esUTaYJgTY2kc=", false, function() {
    return [
...
//# sourceMappingURL=src_9759f5e4._.js.map